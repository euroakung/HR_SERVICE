...
@Component({
  selector: 'app-add-new-ordination-modal',
  templateUrl: './add-new-ordination-modal.component.html',
  styles: []
})
export class AddNewLeaveOrdinationModalComponent implements OnInit  {
  modalRef: BsModalRef; 
